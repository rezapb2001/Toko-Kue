...
<body>
    ...
    <h1 style="color: rgb(117, 77, 48); text-align:center; margin: 35px;"> Checkout </h1>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="card" style="width: 20rem; border-color: rgb(117, 77, 48); text-align: center; padding: 25px; margin: 15px;">
                ...
                <br>
                <br>
                <a href="#" class="btn tombolbayar">Bayar Sekarang</a>
            </div>

            <div class="card" style="width: 20rem; border-color: rgb(117, 77, 48); padding: 25px; margin: 15px;">
                <h3> Pelanggan </h3>
                <?php
                $username = $_SESSION['username'];
                ...
                <table style="font-size: 15px;">
                    <tr>
                        <td>
                            <span style="text-align:center; color: rgb(117, 77, 48);"> Nama</span>
                        </td>
                        <td>
                            <span style="text-align:center; color: rgb(117, 77, 48);">:</span>
                        </td>
                        <td>
                            <span style="color: rgb(117, 77, 48);"><?php echo $data["nama"];  ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span style="text-align:center; color: rgb(117, 77, 48);"> Alamat</span>
                        </td>
                        <td>
                            <span style="text-align:center; color: rgb(117, 77, 48);">:</span>
                        </td>
                        <td>
                            <span style="color: rgb(117, 77, 48);"><?php echo $data["alamat"];  ?></span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <span style="text-align:center; color: rgb(117, 77, 48);">Handphone</span>
                        </td>
                        <td>
                            <span style="text-align:center; color: rgb(117, 77, 48);">:</span>
                        </td>
                        <td>
                            <span style="color: rgb(117, 77, 48);"><?php echo $data["no_tlp"];  ?></span>
                        </td>
                    </tr>
                </table>
            </div>
