...
if (isset($_GET["bagian"])) {
    if ($_GET["bagian"] == "Bread") {
        $kategori = $_GET["bagian"];
    } else if ($_GET["bagian"] == "Traditional Snack") {
        $kategori = $_GET["bagian"];
    } else if ($_GET["bagian"] == "Pastry") {
        $kategori = $_GET["bagian"];
    } else if ($_GET["bagian"] == "Cake") {
        $kategori = $_GET["bagian"];
    } else if ($_GET["bagian"] == "Cup Cake") {
        $kategori = $_GET["bagian"];
    } else if ($_GET["bagian"] == "Snack") {
        $kategori = $_GET["bagian"];
    } else if ($_GET["bagian"] == "Brownies") {
        $kategori = $_GET["bagian"];
    } else if ($_GET["bagian"] == "Package") {
        $kategori = $_GET["bagian"];
    }
}
